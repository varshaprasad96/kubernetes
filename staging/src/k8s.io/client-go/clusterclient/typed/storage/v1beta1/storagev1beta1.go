...
import (
	...
	storageapplyv1beta1 "k8s.io/client-go/applyconfigurations/storage/v1beta1"
	storagev1beta1 "k8s.io/client-go/kubernetes/typed/storage/v1beta1"
	"k8s.io/client-go/rest"
)

// WrappedStorageV1beta1 wraps the client interface with a
// logical cluster.
type WrappedStorageV1beta1 struct {
	cluster  logicalcluster.Name
	delegate storagev1beta1.StorageV1beta1Interface
}

// New creates a WrappedStorageV1beta1 with the given logical cluster and client interface.
func New(cluster logicalcluster.Name, delegate storagev1beta1.StorageV1beta1Interface) *WrappedStorageV1beta1 {
	return &WrappedStorageV1beta1{cluster: cluster, delegate: delegate}
}

// RESTClient returns the underlying RESTClient.
func (w *WrappedStorageV1beta1) RESTClient() rest.Interface {
	return w.delegate.RESTClient()
}

// WrappedStorageV1beta1 contains the wrapped logical cluster and interface.
func (w *WrappedStorageV1beta1) CSIDrivers() storagev1beta1.CSIDriverInterface {
...
type wrappedCSIDriver struct {
	cluster  logicalcluster.Name
	delegate storagev1beta1.CSIDriverInterface
}
...
func (w *wrappedCSIDriver) Get(ctx context.Context, name string, opts metav1.GetOptions) (*storageapiv1beta1.CSIDriver, error) {
...
func (w *wrappedCSIDriver) List(ctx context.Context, opts metav1.ListOptions) (*storageapiv1beta1.CSIDriverList, error) {
	ctx, err := w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
func (w *wrappedCSIDriver) Create(ctx context.Context, cSIDriver *storageapiv1beta1.CSIDriver, opts metav1.CreateOptions) (*storageapiv1beta1.CSIDriver, error) {
	ctx, err := w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
func (w *wrappedCSIDriver) Update(ctx context.Context, cSIDriver *storageapiv1beta1.CSIDriver, opts metav1.UpdateOptions) (*storageapiv1beta1.CSIDriver, error) {
	ctx, err := w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
func (w *wrappedCSIDriver) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (result *storageapiv1beta1.CSIDriver, err error) {
	ctx, err = w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
func (w *wrappedCSIDriver) Apply(ctx context.Context, cSIDriver *storageapplyv1beta1.CSIDriverApplyConfiguration, opts metav1.ApplyOptions) (result *storageapiv1beta1.CSIDriver, err error) {
	ctx, err = w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
// WrappedStorageV1beta1 contains the wrapped logical cluster and interface.
func (w *WrappedStorageV1beta1) CSINodes() storagev1beta1.CSINodeInterface {
...
type wrappedCSINode struct {
	cluster  logicalcluster.Name
	delegate storagev1beta1.CSINodeInterface
}
...
func (w *wrappedCSINode) Get(ctx context.Context, name string, opts metav1.GetOptions) (*storageapiv1beta1.CSINode, error) {
	ctx, err := w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
func (w *wrappedCSINode) List(ctx context.Context, opts metav1.ListOptions) (*storageapiv1beta1.CSINodeList, error) {
	ctx, err := w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
func (w *wrappedCSINode) Create(ctx context.Context, cSINode *storageapiv1beta1.CSINode, opts metav1.CreateOptions) (*storageapiv1beta1.CSINode, error) {
	ctx, err := w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
func (w *wrappedCSINode) Update(ctx context.Context, cSINode *storageapiv1beta1.CSINode, opts metav1.UpdateOptions) (*storageapiv1beta1.CSINode, error) {
	ctx, err := w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
func (w *wrappedCSINode) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (result *storageapiv1beta1.CSINode, err error) {
	ctx, err = w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
func (w *wrappedCSINode) Apply(ctx context.Context, cSINode *storageapplyv1beta1.CSINodeApplyConfiguration, opts metav1.ApplyOptions) (result *storageapiv1beta1.CSINode, err error) {
	ctx, err = w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
// WrappedStorageV1beta1 contains the wrapped logical cluster and interface.
func (w *WrappedStorageV1beta1) CSIStorageCapacities(namespace string) storagev1beta1.CSIStorageCapacityInterface {
...
type wrappedCSIStorageCapacity struct {
	cluster  logicalcluster.Name
	delegate storagev1beta1.CSIStorageCapacityInterface
}
...
func (w *wrappedCSIStorageCapacity) Get(ctx context.Context, name string, opts metav1.GetOptions) (*storageapiv1beta1.CSIStorageCapacity, error) {
	ctx, err := w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
func (w *wrappedCSIStorageCapacity) List(ctx context.Context, opts metav1.ListOptions) (*storageapiv1beta1.CSIStorageCapacityList, error) {
	ctx, err := w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
func (w *wrappedCSIStorageCapacity) Create(ctx context.Context, cSIStorageCapacity *storageapiv1beta1.CSIStorageCapacity, opts metav1.CreateOptions) (*storageapiv1beta1.CSIStorageCapacity, error) {
	ctx, err := w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
func (w *wrappedCSIStorageCapacity) Update(ctx context.Context, cSIStorageCapacity *storageapiv1beta1.CSIStorageCapacity, opts metav1.UpdateOptions) (*storageapiv1beta1.CSIStorageCapacity, error) {
	ctx, err := w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
func (w *wrappedCSIStorageCapacity) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (result *storageapiv1beta1.CSIStorageCapacity, err error) {
	ctx, err = w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
func (w *wrappedCSIStorageCapacity) Apply(ctx context.Context, cSIStorageCapacity *storageapplyv1beta1.CSIStorageCapacityApplyConfiguration, opts metav1.ApplyOptions) (result *storageapiv1beta1.CSIStorageCapacity, err error) {
	ctx, err = w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
// WrappedStorageV1beta1 contains the wrapped logical cluster and interface.
func (w *WrappedStorageV1beta1) StorageClasses() storagev1beta1.StorageClassInterface {
...
type wrappedStorageClass struct {
	cluster  logicalcluster.Name
	delegate storagev1beta1.StorageClassInterface
}
...
func (w *wrappedStorageClass) Get(ctx context.Context, name string, opts metav1.GetOptions) (*storageapiv1beta1.StorageClass, error) {
	ctx, err := w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
func (w *wrappedStorageClass) List(ctx context.Context, opts metav1.ListOptions) (*storageapiv1beta1.StorageClassList, error) {
	ctx, err := w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
func (w *wrappedStorageClass) Create(ctx context.Context, storageClass *storageapiv1beta1.StorageClass, opts metav1.CreateOptions) (*storageapiv1beta1.StorageClass, error) {
	ctx, err := w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
func (w *wrappedStorageClass) Update(ctx context.Context, storageClass *storageapiv1beta1.StorageClass, opts metav1.UpdateOptions) (*storageapiv1beta1.StorageClass, error) {
	ctx, err := w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
func (w *wrappedStorageClass) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (result *storageapiv1beta1.StorageClass, err error) {
	ctx, err = w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
func (w *wrappedStorageClass) Apply(ctx context.Context, storageClass *storageapplyv1beta1.StorageClassApplyConfiguration, opts metav1.ApplyOptions) (result *storageapiv1beta1.StorageClass, err error) {
	ctx, err = w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
// WrappedStorageV1beta1 contains the wrapped logical cluster and interface.
func (w *WrappedStorageV1beta1) VolumeAttachments() storagev1beta1.VolumeAttachmentInterface {
...
type wrappedVolumeAttachment struct {
	cluster  logicalcluster.Name
	delegate storagev1beta1.VolumeAttachmentInterface
}
...
func (w *wrappedVolumeAttachment) Get(ctx context.Context, name string, opts metav1.GetOptions) (*storageapiv1beta1.VolumeAttachment, error) {
	ctx, err := w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
func (w *wrappedVolumeAttachment) List(ctx context.Context, opts metav1.ListOptions) (*storageapiv1beta1.VolumeAttachmentList, error) {
	ctx, err := w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
func (w *wrappedVolumeAttachment) Create(ctx context.Context, volumeAttachment *storageapiv1beta1.VolumeAttachment, opts metav1.CreateOptions) (*storageapiv1beta1.VolumeAttachment, error) {
	ctx, err := w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
func (w *wrappedVolumeAttachment) Update(ctx context.Context, volumeAttachment *storageapiv1beta1.VolumeAttachment, opts metav1.UpdateOptions) (*storageapiv1beta1.VolumeAttachment, error) {
	ctx, err := w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
func (w *wrappedVolumeAttachment) UpdateStatus(ctx context.Context, volumeAttachment *storageapiv1beta1.VolumeAttachment, opts metav1.UpdateOptions) (*storageapiv1beta1.VolumeAttachment, error) {
	ctx, err := w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
func (w *wrappedVolumeAttachment) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (result *storageapiv1beta1.VolumeAttachment, err error) {
	ctx, err = w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
func (w *wrappedVolumeAttachment) Apply(ctx context.Context, volumeAttachment *storageapplyv1beta1.VolumeAttachmentApplyConfiguration, opts metav1.ApplyOptions) (result *storageapiv1beta1.VolumeAttachment, err error) {
	ctx, err = w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
func (w *wrappedVolumeAttachment) ApplyStatus(ctx context.Context, volumeAttachment *storageapplyv1beta1.VolumeAttachmentApplyConfiguration, opts metav1.ApplyOptions) (result *storageapiv1beta1.VolumeAttachment, err error) {
	ctx, err = w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
