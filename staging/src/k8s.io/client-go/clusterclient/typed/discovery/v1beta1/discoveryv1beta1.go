...
import (
	...
	discoveryapiv1beta1 "k8s.io/api/discovery/v1beta1"
	metav1 "k8s.io/apimachinery/pkg/apis/meta/v1"
	"k8s.io/apimachinery/pkg/types"
	"k8s.io/apimachinery/pkg/watch"
	discoveryapplyv1beta1 "k8s.io/client-go/applyconfigurations/discovery/v1beta1"
	discoveryv1beta1 "k8s.io/client-go/kubernetes/typed/discovery/v1beta1"
	"k8s.io/client-go/rest"
)

// WrappedDiscoveryV1beta1 wraps the client interface with a
// logical cluster.
type WrappedDiscoveryV1beta1 struct {
	cluster  logicalcluster.Name
	delegate discoveryv1beta1.DiscoveryV1beta1Interface
}

// New creates a WrappedDiscoveryV1beta1 with the given logical cluster and client interface.
func New(cluster logicalcluster.Name, delegate discoveryv1beta1.DiscoveryV1beta1Interface) *WrappedDiscoveryV1beta1 {
	return &WrappedDiscoveryV1beta1{cluster: cluster, delegate: delegate}
}

// RESTClient returns the underlying RESTClient.
func (w *WrappedDiscoveryV1beta1) RESTClient() rest.Interface {
	return w.delegate.RESTClient()
}

// WrappedDiscoveryV1beta1 contains the wrapped logical cluster and interface.
func (w *WrappedDiscoveryV1beta1) EndpointSlices(namespace string) discoveryv1beta1.EndpointSliceInterface {
...
type wrappedEndpointSlice struct {
	cluster  logicalcluster.Name
	delegate discoveryv1beta1.EndpointSliceInterface
}
...
func (w *wrappedEndpointSlice) Get(ctx context.Context, name string, opts metav1.GetOptions) (*discoveryapiv1beta1.EndpointSlice, error) {
...
func (w *wrappedEndpointSlice) List(ctx context.Context, opts metav1.ListOptions) (*discoveryapiv1beta1.EndpointSliceList, error) {
	ctx, err := w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
func (w *wrappedEndpointSlice) Create(ctx context.Context, endpointSlice *discoveryapiv1beta1.EndpointSlice, opts metav1.CreateOptions) (*discoveryapiv1beta1.EndpointSlice, error) {
	ctx, err := w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
func (w *wrappedEndpointSlice) Update(ctx context.Context, endpointSlice *discoveryapiv1beta1.EndpointSlice, opts metav1.UpdateOptions) (*discoveryapiv1beta1.EndpointSlice, error) {
	ctx, err := w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
func (w *wrappedEndpointSlice) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (result *discoveryapiv1beta1.EndpointSlice, err error) {
	ctx, err = w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
func (w *wrappedEndpointSlice) Apply(ctx context.Context, endpointSlice *discoveryapplyv1beta1.EndpointSliceApplyConfiguration, opts metav1.ApplyOptions) (result *discoveryapiv1beta1.EndpointSlice, err error) {
	ctx, err = w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
