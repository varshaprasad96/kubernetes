...
import (
	...
	eventsapplyv1beta1 "k8s.io/client-go/applyconfigurations/events/v1beta1"
	eventsv1beta1 "k8s.io/client-go/kubernetes/typed/events/v1beta1"
	"k8s.io/client-go/rest"
)

// WrappedEventsV1beta1 wraps the client interface with a
// logical cluster.
type WrappedEventsV1beta1 struct {
	cluster  logicalcluster.Name
	delegate eventsv1beta1.EventsV1beta1Interface
}

// New creates a WrappedEventsV1beta1 with the given logical cluster and client interface.
func New(cluster logicalcluster.Name, delegate eventsv1beta1.EventsV1beta1Interface) *WrappedEventsV1beta1 {
	return &WrappedEventsV1beta1{cluster: cluster, delegate: delegate}
}

// RESTClient returns the underlying RESTClient.
func (w *WrappedEventsV1beta1) RESTClient() rest.Interface {
	return w.delegate.RESTClient()
}

// WrappedEventsV1beta1 contains the wrapped logical cluster and interface.
func (w *WrappedEventsV1beta1) Events(namespace string) eventsv1beta1.EventInterface {
	return &wrappedEvent{
		cluster:  w.cluster,
...
type wrappedEvent struct {
	cluster  logicalcluster.Name
	delegate eventsv1beta1.EventInterface
}
...
func (w *wrappedEvent) Get(ctx context.Context, name string, opts metav1.GetOptions) (*eventsapiv1beta1.Event, error) {
...
func (w *wrappedEvent) List(ctx context.Context, opts metav1.ListOptions) (*eventsapiv1beta1.EventList, error) {
	ctx, err := w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
func (w *wrappedEvent) Create(ctx context.Context, event *eventsapiv1beta1.Event, opts metav1.CreateOptions) (*eventsapiv1beta1.Event, error) {
	ctx, err := w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
func (w *wrappedEvent) Update(ctx context.Context, event *eventsapiv1beta1.Event, opts metav1.UpdateOptions) (*eventsapiv1beta1.Event, error) {
	ctx, err := w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
func (w *wrappedEvent) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (result *eventsapiv1beta1.Event, err error) {
	ctx, err = w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
func (w *wrappedEvent) Apply(ctx context.Context, event *eventsapplyv1beta1.EventApplyConfiguration, opts metav1.ApplyOptions) (result *eventsapiv1beta1.Event, err error) {
	ctx, err = w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
