...
// WrappedPolicyV1 wraps the client interface with a
// logical cluster.
type WrappedPolicyV1 struct {
	cluster  logicalcluster.Name
	delegate policyv1.PolicyV1Interface
}

// New creates a WrappedPolicyV1 with the given logical cluster and client interface.
func New(cluster logicalcluster.Name, delegate policyv1.PolicyV1Interface) *WrappedPolicyV1 {
	return &WrappedPolicyV1{cluster: cluster, delegate: delegate}
}

// RESTClient returns the underlying RESTClient.
func (w *WrappedPolicyV1) RESTClient() rest.Interface {
	return w.delegate.RESTClient()
}

// WrappedPolicyV1 contains the wrapped logical cluster and interface.
func (w *WrappedPolicyV1) Evictions(namespace string) policyv1.EvictionInterface {
...
type wrappedEviction struct {
	cluster  logicalcluster.Name
	delegate policyv1.EvictionInterface
}
...
// WrappedPolicyV1 contains the wrapped logical cluster and interface.
func (w *WrappedPolicyV1) PodDisruptionBudgets(namespace string) policyv1.PodDisruptionBudgetInterface {
...
type wrappedPodDisruptionBudget struct {
	cluster  logicalcluster.Name
	delegate policyv1.PodDisruptionBudgetInterface
}
...
func (w *wrappedPodDisruptionBudget) Get(ctx context.Context, name string, opts metav1.GetOptions) (*policyapiv1.PodDisruptionBudget, error) {
...
func (w *wrappedPodDisruptionBudget) List(ctx context.Context, opts metav1.ListOptions) (*policyapiv1.PodDisruptionBudgetList, error) {
	ctx, err := w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
func (w *wrappedPodDisruptionBudget) Create(ctx context.Context, podDisruptionBudget *policyapiv1.PodDisruptionBudget, opts metav1.CreateOptions) (*policyapiv1.PodDisruptionBudget, error) {
	ctx, err := w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
func (w *wrappedPodDisruptionBudget) Update(ctx context.Context, podDisruptionBudget *policyapiv1.PodDisruptionBudget, opts metav1.UpdateOptions) (*policyapiv1.PodDisruptionBudget, error) {
	ctx, err := w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
func (w *wrappedPodDisruptionBudget) UpdateStatus(ctx context.Context, podDisruptionBudget *policyapiv1.PodDisruptionBudget, opts metav1.UpdateOptions) (*policyapiv1.PodDisruptionBudget, error) {
	ctx, err := w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
func (w *wrappedPodDisruptionBudget) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (result *policyapiv1.PodDisruptionBudget, err error) {
	ctx, err = w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
func (w *wrappedPodDisruptionBudget) Apply(ctx context.Context, podDisruptionBudget *policyapplyv1.PodDisruptionBudgetApplyConfiguration, opts metav1.ApplyOptions) (result *policyapiv1.PodDisruptionBudget, err error) {
	ctx, err = w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
func (w *wrappedPodDisruptionBudget) ApplyStatus(ctx context.Context, podDisruptionBudget *policyapplyv1.PodDisruptionBudgetApplyConfiguration, opts metav1.ApplyOptions) (result *policyapiv1.PodDisruptionBudget, err error) {
	ctx, err = w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
