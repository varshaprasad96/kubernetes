...
import (
	...
	schedulingapplyv1beta1 "k8s.io/client-go/applyconfigurations/scheduling/v1beta1"
	schedulingv1beta1 "k8s.io/client-go/kubernetes/typed/scheduling/v1beta1"
	"k8s.io/client-go/rest"
)

// WrappedSchedulingV1beta1 wraps the client interface with a
// logical cluster.
type WrappedSchedulingV1beta1 struct {
	cluster  logicalcluster.Name
	delegate schedulingv1beta1.SchedulingV1beta1Interface
}

// New creates a WrappedSchedulingV1beta1 with the given logical cluster and client interface.
func New(cluster logicalcluster.Name, delegate schedulingv1beta1.SchedulingV1beta1Interface) *WrappedSchedulingV1beta1 {
	return &WrappedSchedulingV1beta1{cluster: cluster, delegate: delegate}
}

// RESTClient returns the underlying RESTClient.
func (w *WrappedSchedulingV1beta1) RESTClient() rest.Interface {
	return w.delegate.RESTClient()
}

// WrappedSchedulingV1beta1 contains the wrapped logical cluster and interface.
func (w *WrappedSchedulingV1beta1) PriorityClasses() schedulingv1beta1.PriorityClassInterface {
...
type wrappedPriorityClass struct {
	cluster  logicalcluster.Name
	delegate schedulingv1beta1.PriorityClassInterface
}
...
func (w *wrappedPriorityClass) Get(ctx context.Context, name string, opts metav1.GetOptions) (*schedulingapiv1beta1.PriorityClass, error) {
...
func (w *wrappedPriorityClass) List(ctx context.Context, opts metav1.ListOptions) (*schedulingapiv1beta1.PriorityClassList, error) {
	ctx, err := w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
func (w *wrappedPriorityClass) Create(ctx context.Context, priorityClass *schedulingapiv1beta1.PriorityClass, opts metav1.CreateOptions) (*schedulingapiv1beta1.PriorityClass, error) {
	ctx, err := w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
func (w *wrappedPriorityClass) Update(ctx context.Context, priorityClass *schedulingapiv1beta1.PriorityClass, opts metav1.UpdateOptions) (*schedulingapiv1beta1.PriorityClass, error) {
	ctx, err := w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
func (w *wrappedPriorityClass) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (result *schedulingapiv1beta1.PriorityClass, err error) {
	ctx, err = w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
func (w *wrappedPriorityClass) Apply(ctx context.Context, priorityClass *schedulingapplyv1beta1.PriorityClassApplyConfiguration, opts metav1.ApplyOptions) (result *schedulingapiv1beta1.PriorityClass, err error) {
	ctx, err = w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
