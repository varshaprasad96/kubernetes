...
import (
	...
	rbacapplyv1alpha1 "k8s.io/client-go/applyconfigurations/rbac/v1alpha1"
	rbacv1alpha1 "k8s.io/client-go/kubernetes/typed/rbac/v1alpha1"
	"k8s.io/client-go/rest"
)

// WrappedRbacV1alpha1 wraps the client interface with a
// logical cluster.
type WrappedRbacV1alpha1 struct {
	cluster  logicalcluster.Name
	delegate rbacv1alpha1.RbacV1alpha1Interface
}

// New creates a WrappedRbacV1alpha1 with the given logical cluster and client interface.
func New(cluster logicalcluster.Name, delegate rbacv1alpha1.RbacV1alpha1Interface) *WrappedRbacV1alpha1 {
	return &WrappedRbacV1alpha1{cluster: cluster, delegate: delegate}
}

// RESTClient returns the underlying RESTClient.
func (w *WrappedRbacV1alpha1) RESTClient() rest.Interface {
	return w.delegate.RESTClient()
}

// WrappedRbacV1alpha1 contains the wrapped logical cluster and interface.
func (w *WrappedRbacV1alpha1) ClusterRoles() rbacv1alpha1.ClusterRoleInterface {
...
type wrappedClusterRole struct {
	cluster  logicalcluster.Name
	delegate rbacv1alpha1.ClusterRoleInterface
}
...
func (w *wrappedClusterRole) Get(ctx context.Context, name string, opts metav1.GetOptions) (*rbacapiv1alpha1.ClusterRole, error) {
...
func (w *wrappedClusterRole) List(ctx context.Context, opts metav1.ListOptions) (*rbacapiv1alpha1.ClusterRoleList, error) {
	ctx, err := w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
func (w *wrappedClusterRole) Create(ctx context.Context, clusterRole *rbacapiv1alpha1.ClusterRole, opts metav1.CreateOptions) (*rbacapiv1alpha1.ClusterRole, error) {
	ctx, err := w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
func (w *wrappedClusterRole) Update(ctx context.Context, clusterRole *rbacapiv1alpha1.ClusterRole, opts metav1.UpdateOptions) (*rbacapiv1alpha1.ClusterRole, error) {
	ctx, err := w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
func (w *wrappedClusterRole) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (result *rbacapiv1alpha1.ClusterRole, err error) {
	ctx, err = w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
func (w *wrappedClusterRole) Apply(ctx context.Context, clusterRole *rbacapplyv1alpha1.ClusterRoleApplyConfiguration, opts metav1.ApplyOptions) (result *rbacapiv1alpha1.ClusterRole, err error) {
	ctx, err = w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
// WrappedRbacV1alpha1 contains the wrapped logical cluster and interface.
func (w *WrappedRbacV1alpha1) ClusterRoleBindings() rbacv1alpha1.ClusterRoleBindingInterface {
...
type wrappedClusterRoleBinding struct {
	cluster  logicalcluster.Name
	delegate rbacv1alpha1.ClusterRoleBindingInterface
}
...
func (w *wrappedClusterRoleBinding) Get(ctx context.Context, name string, opts metav1.GetOptions) (*rbacapiv1alpha1.ClusterRoleBinding, error) {
	ctx, err := w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
func (w *wrappedClusterRoleBinding) List(ctx context.Context, opts metav1.ListOptions) (*rbacapiv1alpha1.ClusterRoleBindingList, error) {
	ctx, err := w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
func (w *wrappedClusterRoleBinding) Create(ctx context.Context, clusterRoleBinding *rbacapiv1alpha1.ClusterRoleBinding, opts metav1.CreateOptions) (*rbacapiv1alpha1.ClusterRoleBinding, error) {
	ctx, err := w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
func (w *wrappedClusterRoleBinding) Update(ctx context.Context, clusterRoleBinding *rbacapiv1alpha1.ClusterRoleBinding, opts metav1.UpdateOptions) (*rbacapiv1alpha1.ClusterRoleBinding, error) {
	ctx, err := w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
func (w *wrappedClusterRoleBinding) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (result *rbacapiv1alpha1.ClusterRoleBinding, err error) {
	ctx, err = w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
func (w *wrappedClusterRoleBinding) Apply(ctx context.Context, clusterRoleBinding *rbacapplyv1alpha1.ClusterRoleBindingApplyConfiguration, opts metav1.ApplyOptions) (result *rbacapiv1alpha1.ClusterRoleBinding, err error) {
	ctx, err = w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
// WrappedRbacV1alpha1 contains the wrapped logical cluster and interface.
func (w *WrappedRbacV1alpha1) Roles(namespace string) rbacv1alpha1.RoleInterface {
	return &wrappedRole{
		cluster:  w.cluster,
...
type wrappedRole struct {
	cluster  logicalcluster.Name
	delegate rbacv1alpha1.RoleInterface
}
...
func (w *wrappedRole) Get(ctx context.Context, name string, opts metav1.GetOptions) (*rbacapiv1alpha1.Role, error) {
	ctx, err := w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
func (w *wrappedRole) List(ctx context.Context, opts metav1.ListOptions) (*rbacapiv1alpha1.RoleList, error) {
	ctx, err := w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
func (w *wrappedRole) Create(ctx context.Context, role *rbacapiv1alpha1.Role, opts metav1.CreateOptions) (*rbacapiv1alpha1.Role, error) {
	ctx, err := w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
func (w *wrappedRole) Update(ctx context.Context, role *rbacapiv1alpha1.Role, opts metav1.UpdateOptions) (*rbacapiv1alpha1.Role, error) {
	ctx, err := w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
func (w *wrappedRole) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (result *rbacapiv1alpha1.Role, err error) {
	ctx, err = w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
func (w *wrappedRole) Apply(ctx context.Context, role *rbacapplyv1alpha1.RoleApplyConfiguration, opts metav1.ApplyOptions) (result *rbacapiv1alpha1.Role, err error) {
	ctx, err = w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
// WrappedRbacV1alpha1 contains the wrapped logical cluster and interface.
func (w *WrappedRbacV1alpha1) RoleBindings(namespace string) rbacv1alpha1.RoleBindingInterface {
...
type wrappedRoleBinding struct {
	cluster  logicalcluster.Name
	delegate rbacv1alpha1.RoleBindingInterface
}
...
func (w *wrappedRoleBinding) Get(ctx context.Context, name string, opts metav1.GetOptions) (*rbacapiv1alpha1.RoleBinding, error) {
	ctx, err := w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
func (w *wrappedRoleBinding) List(ctx context.Context, opts metav1.ListOptions) (*rbacapiv1alpha1.RoleBindingList, error) {
	ctx, err := w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
func (w *wrappedRoleBinding) Create(ctx context.Context, roleBinding *rbacapiv1alpha1.RoleBinding, opts metav1.CreateOptions) (*rbacapiv1alpha1.RoleBinding, error) {
	ctx, err := w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
func (w *wrappedRoleBinding) Update(ctx context.Context, roleBinding *rbacapiv1alpha1.RoleBinding, opts metav1.UpdateOptions) (*rbacapiv1alpha1.RoleBinding, error) {
	ctx, err := w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
func (w *wrappedRoleBinding) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (result *rbacapiv1alpha1.RoleBinding, err error) {
	ctx, err = w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
func (w *wrappedRoleBinding) Apply(ctx context.Context, roleBinding *rbacapplyv1alpha1.RoleBindingApplyConfiguration, opts metav1.ApplyOptions) (result *rbacapiv1alpha1.RoleBinding, err error) {
	ctx, err = w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
