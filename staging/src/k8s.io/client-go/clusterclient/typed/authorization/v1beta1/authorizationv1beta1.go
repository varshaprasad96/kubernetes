...
// WrappedAuthorizationV1beta1 wraps the client interface with a
// logical cluster.
type WrappedAuthorizationV1beta1 struct {
	cluster  logicalcluster.Name
	delegate authorizationv1beta1.AuthorizationV1beta1Interface
}

// New creates a WrappedAuthorizationV1beta1 with the given logical cluster and client interface.
func New(cluster logicalcluster.Name, delegate authorizationv1beta1.AuthorizationV1beta1Interface) *WrappedAuthorizationV1beta1 {
	return &WrappedAuthorizationV1beta1{cluster: cluster, delegate: delegate}
}

// RESTClient returns the underlying RESTClient.
func (w *WrappedAuthorizationV1beta1) RESTClient() rest.Interface {
	return w.delegate.RESTClient()
}

// WrappedAuthorizationV1beta1 contains the wrapped logical cluster and interface.
func (w *WrappedAuthorizationV1beta1) LocalSubjectAccessReviews(namespace string) authorizationv1beta1.LocalSubjectAccessReviewInterface {
...
type wrappedLocalSubjectAccessReview struct {
	cluster  logicalcluster.Name
	delegate authorizationv1beta1.LocalSubjectAccessReviewInterface
}
...
func (w *wrappedLocalSubjectAccessReview) Create(ctx context.Context, localSubjectAccessReview *authorizationapiv1beta1.LocalSubjectAccessReview, opts metav1.CreateOptions) (*authorizationapiv1beta1.LocalSubjectAccessReview, error) {
...
// WrappedAuthorizationV1beta1 contains the wrapped logical cluster and interface.
func (w *WrappedAuthorizationV1beta1) SelfSubjectAccessReviews() authorizationv1beta1.SelfSubjectAccessReviewInterface {
...
type wrappedSelfSubjectAccessReview struct {
	cluster  logicalcluster.Name
	delegate authorizationv1beta1.SelfSubjectAccessReviewInterface
}
...
func (w *wrappedSelfSubjectAccessReview) Create(ctx context.Context, selfSubjectAccessReview *authorizationapiv1beta1.SelfSubjectAccessReview, opts metav1.CreateOptions) (*authorizationapiv1beta1.SelfSubjectAccessReview, error) {
	ctx, err := w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
// WrappedAuthorizationV1beta1 contains the wrapped logical cluster and interface.
func (w *WrappedAuthorizationV1beta1) SelfSubjectRulesReviews() authorizationv1beta1.SelfSubjectRulesReviewInterface {
...
type wrappedSelfSubjectRulesReview struct {
	cluster  logicalcluster.Name
	delegate authorizationv1beta1.SelfSubjectRulesReviewInterface
}
...
func (w *wrappedSelfSubjectRulesReview) Create(ctx context.Context, selfSubjectRulesReview *authorizationapiv1beta1.SelfSubjectRulesReview, opts metav1.CreateOptions) (*authorizationapiv1beta1.SelfSubjectRulesReview, error) {
	ctx, err := w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
// WrappedAuthorizationV1beta1 contains the wrapped logical cluster and interface.
func (w *WrappedAuthorizationV1beta1) SubjectAccessReviews() authorizationv1beta1.SubjectAccessReviewInterface {
...
type wrappedSubjectAccessReview struct {
	cluster  logicalcluster.Name
	delegate authorizationv1beta1.SubjectAccessReviewInterface
}
...
func (w *wrappedSubjectAccessReview) Create(ctx context.Context, subjectAccessReview *authorizationapiv1beta1.SubjectAccessReview, opts metav1.CreateOptions) (*authorizationapiv1beta1.SubjectAccessReview, error) {
	ctx, err := w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
